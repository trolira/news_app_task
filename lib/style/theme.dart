...
class Colors {
  ...
  static const Color mainColor = const Color(0xFFF6C16A);
  static const Color secondColor = const Color(0xFFF6C16A);
  ...
  static const primaryGradient = const LinearGradient(
    colors: const [Color(0xFFF6C16A), Color(0xFFff7e00)],
    stops: const [0.0, 1.0],
